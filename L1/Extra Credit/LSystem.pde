...
import java.util.Random; // TL Code
...
class LSystem extends BaseLSystem {
 ...
 // Production rules
  ...
  public void iterate() {
    ...
    // set current String to be the new string 
    System.out.println("Output: " + currentIterationBuffer);
      ...
      switch (c) {
        case 'F':
         ...
         case '+':
           ...
           t.left(random(-90, 90));      //TL Code
           break;
         //TL Code Start
         case 'f':
           t.forward(random(1, 50));
           break;
         case 'B':
           t.back(random(1, 50));
           break;
